...
namespace AssessmentProject.Repository.Migrations
{
    ...
    public partial class Models : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "UserConcertsMapping",
                columns: table => new
                {
                    UserConcertsMappingID = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserID = table.Column<int>(type: "integer", nullable: false),
                    ConcertID = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserConcertsMapping", x => x.UserConcertsMappingID);
                    table.ForeignKey(
                        name: "FK_UserConcertsMapping_Concerts_ConcertID",
                        column: x => x.ConcertID,
                        principalTable: "Concerts",
                        principalColumn: "ConcertID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserConcertsMapping_Users_UserID",
                        column: x => x.UserID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserConcertsMapping_ConcertID",
                table: "UserConcertsMapping",
                column: "ConcertID");

            migrationBuilder.CreateIndex(
                name: "IX_UserConcertsMapping_UserID",
                table: "UserConcertsMapping",
                column: "UserID");
